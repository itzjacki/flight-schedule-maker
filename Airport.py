...
class Airport:
    def __init__(self, name, iata, icao, runway_length, yearly_passengers, position, turnaround_factor=1.0):
        self.__name = name
        self.__iata = iata
        self.__icao = icao
        self.__runway_length = runway_length  # Used to see if certain plane type can land on runway, in metres
        self.__yearly_passengers = yearly_passengers  # Amount of outgoing passengers from airport
    ...
    def get_yearly_passengers(self):
        return self.__yearly_passengers
